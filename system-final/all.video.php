...
<body>
        ...
        <div class="navbar">
            ...
            <div class="dropCon">
                ...
                <ul class="menuCon dropdown-menu">
                    <li><a class="item active" href="all.video.php">All</a></li>
    ...
    <section>
        <div class="contents">
            ...
            <div class="nav">
                <a class= "active" href="all.video.php">All</a>
                <a class= "" href="tutorial.video.php">Tutorials</a>
                <a class= "" href="gameplay.video.php">Entertainment</a>
                <a class= "" href="esport.video.php">eSport</a>
            </div>

            <div class="content2">
            <?php
                $vidSql = "SELECT * FROM tutorials UNION ALL SELECT * FROM gameplay UNION ALL SELECT * FROM esport ORDER BY RAND()"; 
                $vidQuery = $insertPic->query($vidSql);

                    while($Listrows = mysqli_fetch_assoc($vidQuery)){
                        $txtLimit = 40;
            ?>
                        <div class="videoCon">
                                <a class="passBtn" href="play.video.php" data-id="<?php echo $Listrows['id'] ?>" data-type="<?php echo $Listrows['type'] ?>">
                                    <video src="videos/<?php echo $Listrows['video'] ?>" type="video/mp4" width="280px" height="auto" muted></video> 
                                    
                                    <div class="uploaderCon">
                                        <?php
                                            $userQuery = $insertPic->FetchUploader($Listrows['uploaderId']);
