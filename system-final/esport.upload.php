...
<head>
    ...
    <link rel="stylesheet" href="esport.upload.css">
...
<body>
            ...
            <div class="nav">
                ...
                <div class="dropCon">
                    ...
                    <ul class="menuCon dropdown-menu">
                        <li><a class="item active" href="esport.upload.php">Videos</a></li>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form action="includes/esport.b.php?type=video" method="post" enctype="multipart/form-data">
    ...
    <div id="deleteModal" class="modal3">
        <div class="modal3-dialog">
            <div class="modal3-content">
                ...
                <form id="deleteForm" action="includes/e.delete.php" method="post">
