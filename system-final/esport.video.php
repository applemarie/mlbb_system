        ...
        <div class="navbar">
            ...
            <div class="dropCon">
                ...
                <ul class="menuCon dropdown-menu">
                    ...
                    <li><a class="item" href="gamplay.video.php">Entertainment</a></li>
                    <li><a class="item active" href="#">eSPORT</a></li>
                </ul>
            </div>
            <div class="dropCon">
                <div class="drop dropdown-toggle" data-bs-toggle="dropdown">
    ...
    <section>
        <div class="contents">
            ...
            <div class="nav">
                ...
                <a class= "active" href="esport.video.php">eSport</a>
            </div>

            <div class="content2">
                <?php
                    $query = $insertPic->esportVid();
