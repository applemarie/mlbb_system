...
<body>
    ...
    <section>
        <div class="contents">
            ...
            <div class="nav">
                ...
                <a class= "<?php echo($role == 0 ? 'd-block' : 'd-none') ?> active" href="game.update.php">Game Updates</a>
                <div class="dropCon">
                    <div class="drop dropdown-toggle" data-bs-toggle="dropdown">
                        eSPORT
                    </div>
                ...
                <div class="updateCon">
                    ...
                    $type = "patches";
                        ...
                        while($row = mysqli_fetch_assoc($query)){
                            $picture = $row['picture'];
                    ?>
                    <div id="<?php echo $row['id'] ?>" class="updates">
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form action="includes/patches.b.php" method="post" enctype="multipart/form-data">
                <input type="file" name="profile" class="image"> 
                <input type="text" name="title" placeholder="Title">
                <div class="Type">
                    <div>
                        <input name="Type" type="radio" id="tutorial" value="Hero Release">
                        <label for="tutorial">Hero Release</label>
                    </div>
                    <div>
                        <input name="Type" type="radio" id="entertain" value="Hero Revamp">
                        <label for="entertain">Hero Revamp</label>
                    </div>
                    <div>
                        <input name="Type" type="radio" id="entertain" value="New Skin">
                        <label for="entertain">New Skin</label>
                    </div>
                    <div>
                        <input name="Type" type="radio" id="entertain" value="Game Update">
                        <label for="entertain">Game Update</label>
                    </div>
                </div>  
