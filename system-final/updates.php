...
<body>
    ...
    <header>
        ...
        <div class="navbar">
            ...
            <div class="dropCon">
                ...
                <ul class="menuCon dropdown-menu">
                    <li><a class="item active" href="updates.php">New Patches</a></li>
    ...
    <section>
        <div class="contents">
            ...
            <div class="nav">
                <a class="list-group-item-action active" href="updates.php">New Patches</a>
                <a href="esport.php">eSPORT</a>
            </div>

            <div class="content2">
                <h5 class="page_title">New Patches</h5>
                <div class="updateCon">
                    <?php
                    $type = "patches";
