    ...
    <section>
        <div class="contents">
            ...
            <div class="nav">
                ...
                <a class= "<?php echo($role == 0 ? 'd-block' : 'd-none') ?> active" href="user.uploads.php">User Uploads</a>  
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql2 = "SELECT * FROM tutorials WHERE tutorials.uploaderId='$userId' UNION ALL SELECT * FROM gameplay WHERE gameplay.uploaderId='$userId'"; 
                        ...
                        <tr>
                            <td>
                                <a  class="delete-btn" href="#deleteModal" data-id="<?php echo $rows['id'];?>" data-type="<?php echo $rows['type'] ?>">
                            ...
                            <td>
                                <?php
                                    $txtLimit = 30;
                                    if(strlen($rows['title']) > $txtLimit){
                                        echo substr($rows['title'], 0, $txtLimit) . "..."; 
                                    }else{
                                        echo $rows['title']; 
                                    }
                                ?>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="deleteForm" action="includes/video.delete.php" method="post">
